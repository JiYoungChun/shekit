...
function preload() {
  ...
  foodIcon = loadImage("img/food.png");
  barIcon = loadImage("img/bar.png");
  dessertIcon = loadImage("img/icecream.png");
  grey = loadImage("img/greyParticle.png");
  //white=loadImage("img/whiteparticles.png");
  star1 = loadImage("img/1star.png");
   star2 = loadImage("img/2star.png");
   star3 = loadImage("img/3star.png");
   star4 = loadImage("img/4star.png");
   star5 = loadImage("img/5star.png");
   foot1 = loadImage("img/1foot.png");
   foot2 = loadImage("img/2foot.png");
   foot3 = loadImage("img/3foot.png");
   foot4 = loadImage("img/4foot.png");
   foot5 = loadImage("img/5foot.png");
}
...
for (var i = 0; i < 100; i++) {
  ...
  space2 = loadImage("img/space2.jpg");
  comet = loadImage("img/comet.png");
  //image(space1,0,0);
